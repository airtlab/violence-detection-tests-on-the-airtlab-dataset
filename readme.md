...
- the "[Transfer_Learning_Violence_Detection_On_AIRTLab_Dataset_(2D_CNNs_+_Bi-LSTM).ipynb](notebook/transfer-learning/Transfer_Learning_Violence_Detection_On_AIRTLab_Dataset_(2D_CNNs_%2B_Bi_LSTM).ipynb)" notebook includes the accuracy tests of five 2D CNNs trained on ImageNet combined with a Bidirectional-LSTM, on the AIRTLab dataset;
